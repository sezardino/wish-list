import { BrandLogo } from "@/components/modules/layout/brand-logo";
        ...
        <div className="container">
          ...
          <div className="mx-auto flex max-w-5xl flex-col items-center">
            <div className="z-10 flex flex-col items-center gap-6 text-center">
              <BrandLogo isTextHidden size="xl" />

              <Chip size="sm" color="secondary">
                {homeHeroSection.subHeadline}
              </Chip>
              ...
              <Button as={Link} href="#features" color="primary">
                {homeHeroSection.cta}
              </Button>
            </div>
          </div>
